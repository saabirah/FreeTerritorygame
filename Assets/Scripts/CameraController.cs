...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Joystick:
        angleH += Mathf.Clamp(Input.GetAxis("Horizontal"), -1, 1) * 60 * horizontalAimingSpeed * Time.deltaTime;
        angleV += Mathf.Clamp(Input.GetAxis("Vertical"), -1, 1) * 60 * verticalAimingSpeed * Time.deltaTime;
